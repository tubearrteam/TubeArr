...
namespace TubeArr.Backend.Persistence.Migrations
{
    ...
    [Migration("20260402071400_AddCustomPlaylistPlexMembership")]
    partial class AddCustomPlaylistPlexMembership
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TubeArr.Backend.Data.ChannelCustomPlaylistMembershipAppliedEntity", b =>
                {
                    b.Property<int>("ChannelId")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ChannelCustomPlaylistMembershipApplied");
                });

            modelBuilder.Entity("TubeArr.Backend.Data.ChannelCustomPlaylistVideoMembershipEntity", b =>
                {
                    b.Property<int>("ChannelCustomPlaylistId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("ChannelCustomPlaylistId", "VideoId");

                    b.HasIndex("VideoId");

                    b.ToTable("ChannelCustomPlaylistVideoMemberships");
                });
            ...
            modelBuilder.Entity("TubeArr.Backend.Data.ChannelEntity", b =>
                {
                    ...
                    b.Property<int>("CustomPlaylistMembershipVersion")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TubeArr.Backend.Data.ChannelCustomPlaylistVideoMembershipEntity", b =>
                {
                    b.HasOne("TubeArr.Backend.Data.ChannelCustomPlaylistEntity", null)
                        .WithMany()
                        .HasForeignKey("ChannelCustomPlaylistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
