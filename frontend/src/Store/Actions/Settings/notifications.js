  ...
  reducers: {
    ...
    [SELECT_NOTIFICATION_SCHEMA]: (state, { payload }) => {
      return selectProviderSchema(state, section, payload, (selectedSchema) => {
        ...
        selectedSchema.onChannelAdd = selectedSchema.supportsOnChannelAdd;
        selectedSchema.onChannelDelete = selectedSchema.supportsOnChannelDelete;
        selectedSchema.onVideoFileDelete = selectedSchema.supportsOnVideoFileDelete;
        selectedSchema.onVideoFileDeleteForUpgrade = selectedSchema.supportsOnVideoFileDeleteForUpgrade;
