...
import createBatchToggleVideoMonitoredHandler from './Creators/createBatchToggleVideoMonitoredHandler';
...
export const BATCH_TOGGLE_MISSING_VIDEOS = 'wanted/missing/batchToggleMissingVideos';
...
export const BATCH_TOGGLE_CUTOFF_UNMET_VIDEOS = 'wanted/cutoffUnmet/batchToggleCutoffUnmetVideos';
...
export const batchToggleMissingVideos = createThunk(BATCH_TOGGLE_MISSING_VIDEOS);
...
export const batchToggleCutoffUnmetVideos = createThunk(BATCH_TOGGLE_CUTOFF_UNMET_VIDEOS);
...
export const actionHandlers = handleThunks({
  ...
  [BATCH_TOGGLE_MISSING_VIDEOS]: createBatchToggleVideoMonitoredHandler('wanted.missing', fetchMissing),
  ...
  [BATCH_TOGGLE_CUTOFF_UNMET_VIDEOS]: createBatchToggleVideoMonitoredHandler('wanted.cutoffUnmet', fetchCutoffUnmet)
