...
export const videoSection = 'releases.video';
export const playlistSection = 'releases.playlist';
...
export const defaultState = {
  ...
  filters: [
    ...
    {
      key: 'not-playlist-pack',
      label: () => translate('NotPlaylistPack'),
      filters: [
        {
          key: 'fullPlaylist',
          value: false,
  ...
  filterBuilderProps: [
    ...
    {
      name: 'videoRequested',
      label: () => translate('VideoRequested'),
      type: filterBuilderTypes.EXACT,
      valueType: filterBuilderValueTypes.BOOL
    }
  ],
  ...
  playlist: {
    selectedFilterKey: 'playlist-pack'
  }
};

export const persistState = [
  'releases.video.selectedFilterKey',
  'releases.video.customFilters',
  'releases.playlist.selectedFilterKey',
  'releases.playlist.customFilters'
];
...
export const SET_VIDEO_RELEASES_FILTER = 'releases/setVideoReleasesFilter';
export const SET_PLAYLIST_RELEASES_FILTER = 'releases/setPlaylistReleasesFilter';
...
export const setVideoReleasesFilter = createAction(SET_VIDEO_RELEASES_FILTER);
export const setPlaylistReleasesFilter = createAction(SET_PLAYLIST_RELEASES_FILTER);
...
export const reducers = createHandleActions({
  ...
  [SET_VIDEO_RELEASES_FILTER]: createSetClientSideCollectionFilterReducer(videoSection),
  [SET_PLAYLIST_RELEASES_FILTER]: createSetClientSideCollectionFilterReducer(playlistSection)
