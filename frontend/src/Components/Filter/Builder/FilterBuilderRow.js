...
import PlaylistsMonitoredStatusFilterBuilderRowValue from './PlaylistsMonitoredStatusFilterBuilderRowValue';
import ChannelFilterBuilderRowValue from './ChannelFilterBuilderRowValue';
import ChannelStatusFilterBuilderRowValue from './ChannelStatusFilterBuilderRowValue';
import ChannelTypeFilterBuilderRowValue from './ChannelTypeFilterBuilderRowValue';
...
function getRowValueConnector(selectedFilterBuilderProp) {
  ...
  switch (valueType) {
    ...
    case filterBuilderValueTypes.PLAYLISTS_MONITORED_STATUS:
      return PlaylistsMonitoredStatusFilterBuilderRowValue;

    case filterBuilderValueTypes.CHANNEL:
      return ChannelFilterBuilderRowValue;

    case filterBuilderValueTypes.CHANNEL_STATUS:
      return ChannelStatusFilterBuilderRowValue;

    case filterBuilderValueTypes.CHANNEL_TYPES:
      return ChannelTypeFilterBuilderRowValue;
