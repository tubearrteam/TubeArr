...
const links = [
  {
    iconName: icons.CHANNEL_CONTINUING,
...

  {
    ...
    children: [
      {
        title: () => `${translate('Download')} ${translate('Queue')}`,
        to: '/activity/download-queue'
      },
      {
        title: () => `${translate('Metadata')} ${translate('Queue')}`,
  ...
  },
  {
    ...
    children: [
      ...
      // Metadata, MetadataSource: to enable, uncomment these + route + import in App/AppRoutes.tsx + link block in Settings/Settings.js
      // {
...
class PageSidebar extends Component {
  ...
  render() {
    ...
    const urlBase = window.TubeArr.urlBase;
