...
import ChannelSearchInputConnector from './ChannelSearchInputConnector';
        ...
        <div className={styles.logoContainer}>
          ...
          >
            <img
              ...
              src={`${window.TubeArr.urlBase}/Content/Images/logo.svg`}
              alt={translate('TubeArrLogoAlt')}
            />
          </Link>
        </div>
