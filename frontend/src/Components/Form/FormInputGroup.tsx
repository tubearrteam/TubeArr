...
import ChannelTypeSelectInput from './Select/ChannelTypeSelectInput';
import UMaskInput from './Select/UMaskInput';
import DeviceInput from './Tag/DeviceInput';
import ChannelTagInput from './Tag/ChannelTagInput';
...
function getComponent(type: InputType) {
  switch (type) {
    ...
    case inputTypes.MONITOR_VIDEOS_SELECT:
      return MonitorVideosSelectInput;
    ...
    case inputTypes.TAG:
    case inputTypes.CHANNEL_TAG:
      return ChannelTagInput;

    case inputTypes.CHANNEL_TYPE_SELECT:
      return ChannelTypeSelectInput;
