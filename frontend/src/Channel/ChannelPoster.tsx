...
import ChannelImage, { ChannelImageProps } from './ChannelImage';
...
interface ChannelPosterProps
  extends Omit<ChannelImageProps, 'coverType' | 'placeholder'> {
  size?: 250 | 500;
}

function ChannelPoster({ size = 250, ...otherProps }: ChannelPosterProps) {
  return (
    <ChannelImage
      {...otherProps}
      size={size}
