...
import ChannelIndexOverview from './ChannelIndexOverview';
...
interface ChannelIndexOverviewsProps {
  items: Channel[];
  sortKey: string;
...
function Row({ index, style, data }: ListChildComponentProps<RowItemData>) {
  ...
  return (
    <div style={style}>
      <ChannelIndexOverview channelId={channel.id} {...otherData} />
    </div>
  );
}
...
function ChannelIndexOverviews(props: ChannelIndexOverviewsProps) {
  const {
    items,
    sortKey,
    jumpToCharacter,
...
export default ChannelIndexOverviews;
