...
import { setChannelOverviewOption } from 'Store/Actions/channelIndexActions';
...
interface ChannelIndexOverviewOptionsModalContentProps {
  onModalClose(...args: unknown[]): void;
}

function ChannelIndexOverviewOptionsModalContent(
  props: ChannelIndexOverviewOptionsModalContentProps
) {
  ...
  const onOverviewOptionChange = useCallback(
    ({ name, value }: { name: string; value: unknown }) => {
      dispatch(setChannelOverviewOption({ [name]: value }));
    },
    [dispatch]
  );
    ...
    <ModalContent onModalClose={onModalClose}>
      ...
      <ModalBody>
        <Form>
          ...
          <FormGroup>
            <FormLabel>{translate('ShowPlaylistCount')}</FormLabel>

            <FormInputGroup
              type={inputTypes.CHECK}
              name="showPlaylistCount"
              value={showPlaylistCount}
              onChange={onOverviewOptionChange}
            />
          </FormGroup>
...
export default ChannelIndexOverviewOptionsModalContent;
