...
import ChannelIndexRow from './ChannelIndexRow';
import ChannelIndexTableHeader from './ChannelIndexTableHeader';
import styles from './ChannelIndexTable.css';
...
interface ChannelIndexTableProps {
  items: Channel[];
  sortKey: string;
...
const columnsSelector = createSelector(
  (state: AppState) => state.channelIndex.columns,
  (columns) => columns
);
...
function ChannelIndexTable(props: ChannelIndexTableProps) {
  const {
    items,
    sortKey,
    sortDirection,
