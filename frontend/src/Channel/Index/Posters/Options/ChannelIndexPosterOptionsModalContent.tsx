...
import selectPosterOptions from 'Channel/Index/Posters/selectPosterOptions';
import { setChannelPosterOption } from 'Store/Actions/channelIndexActions';
...
interface ChannelIndexPosterOptionsModalContentProps {
  onModalClose(...args: unknown[]): unknown;
}

function ChannelIndexPosterOptionsModalContent(
  props: ChannelIndexPosterOptionsModalContentProps
) {
  ...
  const onPosterOptionChange = useCallback(
    ({ name, value }: { name: string; value: unknown }) => {
      dispatch(setChannelPosterOption({ [name]: value }));
    },
    [dispatch]
  );
        ...
        <Form>
          ...
          <FormGroup>
            ...
            <FormInputGroup
              ...
              name="showTitle"
              value={showTitle}
              helpText={translate('ShowChannelTitleHelpText')}
              onChange={onPosterOptionChange}
            />
          </FormGroup>
...
export default ChannelIndexPosterOptionsModalContent;
