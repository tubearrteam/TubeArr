...
interface ChannelIndexSelectAllButtonProps {
  label: string;
  isSelectMode: boolean;
  overflowComponent: React.FunctionComponent<never>;
}

function ChannelIndexSelectAllButton(props: ChannelIndexSelectAllButtonProps) {
...
export default ChannelIndexSelectAllButton;
