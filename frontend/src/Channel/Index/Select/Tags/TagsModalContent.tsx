...
function TagsModalContent(props: TagsModalContentProps) {
  const { channelIds, onModalClose, onApplyTagsPress } = props;
  ...
  const channelTags = useMemo(() => {
    const tags = channelIds.reduce((acc: number[], id) => {
      const channel = allChannels.find((c) => c.id === id);

      if (channel) {
        acc.push(...channel.tags);
      }
        ...
        <Form>
          ...
          <FormGroup>
            ...
            <FormInputGroup
              ...
              helpTexts={[
                translate('ApplyTagsHelpTextHowToApplyChannel'),
