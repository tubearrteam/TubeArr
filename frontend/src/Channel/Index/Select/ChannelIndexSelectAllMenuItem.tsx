...
interface ChannelIndexSelectAllMenuItemProps {
  label: string;
  isSelectMode: boolean;
}

function ChannelIndexSelectAllMenuItem(
  props: ChannelIndexSelectAllMenuItemProps
) {
...
export default ChannelIndexSelectAllMenuItem;
