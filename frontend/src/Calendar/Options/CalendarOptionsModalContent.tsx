    ...
    <ModalContent onModalClose={onModalClose}>
      ...
      <ModalBody>
        <FieldSet legend={translate('Local')}>
          <Form>
            <FormGroup>
              <FormLabel>{translate('CollapseMultipleVideos')}</FormLabel>

              <FormInputGroup
                type={inputTypes.CHECK}
                name="collapseMultipleVideos"
                value={collapseMultipleVideos}
                helpText={translate('CollapseMultipleVideosHelpText')}
                onChange={handleOptionInputChange}
              />
            </FormGroup>

            <FormGroup>
              <FormLabel>{translate('ShowVideoInformation')}</FormLabel>

              <FormInputGroup
                type={inputTypes.CHECK}
                name="showVideoInformation"
                value={showVideoInformation}
                helpText={translate('ShowVideoInformationHelpText')}
                onChange={handleOptionInputChange}
              />
            </FormGroup>
