...
function EditImportListExclusionModalContent({
  ...
  const { title, youtubeChannelId } = item;
          ...
          <Form {...otherProps}>
            <FormGroup>
              ...
              <FormInputGroup
                ...
                name="title"
                helpText={translate('ChannelTitleToExcludeHelpText')}
                {...title}
            ...
            <FormGroup>
              <FormLabel>{translate('YouTubeChannelId')}</FormLabel>

              <FormInputGroup
                type={inputTypes.TEXT}
                name="youtubeChannelId"
                helpText={translate('YouTubeChannelIdExcludeHelpText')}
                {...youtubeChannelId}
                onChange={onInputChange}
              />
            </FormGroup>
