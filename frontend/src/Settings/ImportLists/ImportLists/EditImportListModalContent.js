...
import ChannelMonitorNewItemsOptionsPopoverContent from 'AddChannel/ChannelMonitorNewItemsOptionsPopoverContent';
            ...
            <Form {...otherProps}>
              ...
              <FormGroup>
                ...
                <FormInputGroup
                  ...
                  helpText={translate('EnableAutomaticAddChannelHelpText')}
                  {...enableAutomaticAdd}
                  onChange={onInputChange}
                />
              </FormGroup>
              ...
              <FormGroup>
                <FormLabel>{translate('ImportListSearchForMissingVideos')}</FormLabel>

                <FormInputGroup
                  type={inputTypes.CHECK}
                  name="searchForMissingVideos"
                  helpText={translate('ImportListSearchForMissingVideosHelpText')}
                  {...searchForMissingVideos}
                  onChange={onInputChange}
                />
              </FormGroup>
              ...
              <FormGroup>
                <FormLabel>
                  ...
                  <Popover
                    ...
                    title={translate('MonitorNewPlaylists')}
                    body={<ChannelMonitorNewItemsOptionsPopoverContent />}
                    position={tooltipPositions.RIGHT}
                  />
                </FormLabel>
                ...
                <FormInputGroup
                  ...
                  helpText={translate('MonitorNewPlaylistsHelpText')}
                  {...monitorNewItems}
                  onChange={onInputChange}
                />
              </FormGroup>
              ...
              <FormGroup>
                <FormLabel>{translate('AppTags')}</FormLabel>
