...
import styles from './ImportChannelSelectFolder.css';

class ImportChannelSelectFolder extends Component {
            ...
            !error && isPopulated &&
              <div>
                <div className={styles.header}>
                  {translate('LibraryImportChannelHeader')}
                </div>
                ...
                <div className={styles.tips}>
                  ...
                  <ul>
                    <li className={styles.tip}>
                      <InlineMarkdown data={translate('LibraryImportTipsQualityInVideoFilename')} />
                    </li>
                    <li className={styles.tip}>
                      <InlineMarkdown data={translate('LibraryImportTipsChannelUseRootFolder', { goodFolderExample, badFolderExample })} />
                    </li>
                    <li className={styles.tip}>
...
ImportChannelSelectFolder.propTypes = {
...
export default ImportChannelSelectFolder;
